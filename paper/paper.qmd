...
To visualize our data, we create a table and graph. @tbl-variables shows a sample of the dataset with all the variables and the first 10 out of 140 observations. Furthermore, @fig-variables show a scatterplot of the data with all 140 observations. We see a positive correlation between the number of Spotify streams and weeks spent on the *Billboard Hot 100*.
