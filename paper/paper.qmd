...
Beyoncé Giselle Knowles-Carter is a singer, songwriter, producer, dancer, and one of the most successful and influential artists of our time. Over the course of her career, she has won 32 Grammy Awards, sold beyond 200 million records, and more than 100 of her songs have landed on the *Billboard Hot 100* chart. The *Billboard Hot 100* is a music ranking system that showcases 100 of the most popular songs in the United States each week. Although the exact formula behind its calculation remains unknown to the public, the two main components are radio and song sales. Listeners can stream these hits on Spotify, the world’s most popular audio streaming subscription service.

There is a clear gap in knowing what makes a song famous. In the ever-changing music industry, it is not only about melody and lyrics, but also promotion. In this paper, we look at music promotion and the importance of Billboard charting. We analyze the number of Spotify streams of a Beyoncé song based on the number of weeks it spent on the *Billboard Hot 100*. The estimand is the popularity of a Beyoncé song and this is considered in the number of Spotify streams.
