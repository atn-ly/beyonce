...
Beyoncé Giselle Knowles-Carter is a singer, songwriter, producer, dancer, and one of the most successful and influential artists of our time. Over the course of her career, she has won 32 Grammy Awards, sold more than 200 million records, and 106 of her songs have landed on the *Billboard Hot 100* chart. The *Billboard Hot 100* is a music ranking system that showcases 100 of the most popular songs in the United States. Although the exact formulas behind its calculation remain unknown to the public, the two main components are radio and song sales. Listeners can stream these hits on Spotify. With more than 602 million users, it is the world’s most popular audio streaming subscription service. 
