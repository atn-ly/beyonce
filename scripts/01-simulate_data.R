#### Preamble ####
# Purpose: Simulates a dataset of number of Spotify streams and number of
...
#### Style code ####
lint(filename = here("scripts/01-simulate_data.R"))
style_file(path = here("scripts/01-simulate_data.R"))
